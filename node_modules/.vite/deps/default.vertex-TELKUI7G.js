...
var name9 = "morphTargetsVertexGlobalDeclaration";
var shader9 = `#ifdef MORPHTARGETS
...
var name10 = "morphTargetsVertexDeclaration";
var shader10 = `#ifdef MORPHTARGETS
...
var name11 = "morphTargetsVertexGlobal";
...
var name13 = "prePassVertex";
var shader13 = `#ifdef PREPASS_DEPTH
...
var name14 = "uvVariableDeclaration";
var shader14 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var name15 = "samplerVertexImplementation";
var shader15 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
var name16 = "bumpVertex";
var shader16 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
var name17 = "shadowsVertex";
var shader17 = `#ifdef SHADOWS
...
var name18 = "pointCloudVertex";
var shader18 = `#if defined(POINTSIZE) && !defined(WEBGPU)
...
var name20 = "defaultVertexShader";
var shader20 = `#define CUSTOM_VERTEX_EXTENSION
...
var defaultVertexShader = { name: name20, shader: shader20 };
export {
  defaultVertexShader
};
//# sourceMappingURL=default.vertex-TELKUI7G.js.map
