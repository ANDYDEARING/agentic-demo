import "./chunk-ENGLJVD6.js";
import "./chunk-OOZJY3VB.js";
...
var name8 = "clusteredLightingFunctions";
var shader8 = `struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
var name9 = "lightsFragmentFunctions";
var shader9 = `struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
var name10 = "shadowsFragmentFunctions";
...
var name11 = "samplerFragmentDeclaration";
var shader11 = `#ifdef _DEFINENAME_
...
var name12 = "fresnelFunction";
var shader12 = `#ifdef FRESNEL
...
var name13 = "reflectionFunction";
var shader13 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
var name14 = "imageProcessingDeclaration";
var shader14 = `#ifdef EXPOSURE
...
var name15 = "imageProcessingFunctions";
var shader15 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
var name16 = "bumpFragmentMainFunctions";
var shader16 = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
var name17 = "bumpFragmentFunctions";
var shader17 = `#if defined(BUMP)
...
var name18 = "bumpFragment";
var shader18 = `vec2 uvOffset=vec2(0.0,0.0);
...
var name19 = "decalFragment";
var shader19 = `#ifdef DECAL
#ifdef GAMMADECAL
...
var name23 = "oitFragment";
var shader23 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var shader24 = `#define CUSTOM_FRAGMENT_EXTENSION
...
var defaultPixelShader = { name: name24, shader: shader24 };
export {
  defaultPixelShader
};
//# sourceMappingURL=default.fragment-7JQJH5R4.js.map
