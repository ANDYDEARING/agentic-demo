      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-SPDDC466.js"), import("./default.fragment-QQ2FVKEG.js")]);
          } else {
            await Promise.all([import("./default.vertex-TELKUI7G.js"), import("./default.fragment-7JQJH5R4.js")]);
          }
